...
import '../../features/settings/views/information_screen.dart';
import '../../features/viewer/views/viewer_screen.dart';

// タブの中身（設定・お気に入り・情報・ビューア・本棚・新規タブの
// プレースホルダー）を出し分けるロジック。デスクトップ(TabShell/_MainArea)・
// モバイル(MobileShell)の両方から共通で呼ばれる
Widget buildTabContent(TabItem tab, bool isActive) {
  ...
  if (tab.isInformation) return InformationScreen(isActive: isActive);
  if (tab.bookId != null) {
